...
Welcome to `ad-fidelity` contributor's guide.
...
If you experience bugs or general issues with `ad-fidelity`, please have a look
...
You can help improve `ad-fidelity` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ad-fidelity` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ad-fidelity`'s files. While this mechanism can
...
```
conda create -n ad-fidelity python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ad-fidelity.git
   cd ad-fidelity
   ```
...
5. Install [pre-commit]:
   ...
   `ad-fidelity` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ad-fidelity
[issue tracker]: https://github.com/<USERNAME>/ad-fidelity/issues
