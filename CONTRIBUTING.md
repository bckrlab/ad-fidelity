...
Welcome to `xai-ad-eval` contributor's guide.
...
If you experience bugs or general issues with `xai-ad-eval`, please have a look
...
You can help improve `xai-ad-eval` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`xai-ad-eval` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `xai-ad-eval`'s files. While this mechanism can
...
```
conda create -n xai-ad-eval python=3 six virtualenv pytest pytest-cov
conda activate xai-ad-eval
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/xai-ad-eval.git
   cd xai-ad-eval
   ```
...
5. Install [pre-commit]:
   ...
   `xai-ad-eval` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/xai-ad-eval
[issue tracker]: https://github.com/<USERNAME>/xai-ad-eval/issues
