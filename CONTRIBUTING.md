...
Welcome to `ad-deletion` contributor's guide.
...
If you experience bugs or general issues with `ad-deletion`, please have a look
...
You can help improve `ad-deletion` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ad-deletion` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ad-deletion`'s files. While this mechanism can
...
```
conda create -n ad-deletion python=3 six virtualenv pytest pytest-cov
conda activate ad-deletion
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ad-deletion.git
   cd ad-deletion
   ```
...
5. Install [pre-commit]:
   ...
   `ad-deletion` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ad-deletion
[issue tracker]: https://github.com/<USERNAME>/ad-deletion/issues
